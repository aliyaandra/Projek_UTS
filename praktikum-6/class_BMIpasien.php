...
<table class="table">
  ...
  <tbody>
    ...
    $nomor = 1;
    $bb1 = new bmi("NF001", "Anisa", "P", 69.8, 169);
    $bb1->tanggal = "2022-01-15";
    $bb2 = new bmi("NF002", "Malik", "L", 55.3, 165);
    $bb2->tanggal = "2022-01-20";
    $bb3 = new bmi("NF003", "Okta", "P", 45.2, 171);
    $bb3->tanggal = "2022-01-25";
